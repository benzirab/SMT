...
class JCart {
    ...
    public function display_cart() {
        ...
        if ($isCheckout !== true) {
            ...
            echo tab(7) . "<input type='$inputType' $src id='jcart-checkout' name='jcartCheckout' class='jcart-button' value='{$config['text']['checkout']}' hidden />\n";
        }
        ...
        if($this->itemCount > 0) {
            ...
            foreach($this->get_contents() as $item)	{
                ...
                echo tab(7) . "<input id='jcartItemQty-{$item['id']}' name='jcartItemQty[]' size='6' type='text' value='{$item['qty']}' disabled/>\n";
                echo tab(6) . "</td>\n";
                ...
                echo tab(7) . "<span>" . number_format($item['subtotal'], $priceFormat['decimals'], $priceFormat['dec_point'], $priceFormat['thousands_sep']) . " $currencySymbol</span><input name='jcartItemPrice[]' type='hidden' value='{$item['price']}' />\n";
